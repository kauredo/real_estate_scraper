...
const PreviewModal: React.FC<PreviewModalProps> = ({
  ...
  return (
    ...
    >
        ...
        <div className="flex gap-2">
          {(Object.keys(DEVICES) as DeviceType[]).map((deviceType) => (
            ...
            >
              ...
              <span className="hidden sm:inline">{DEVICES[deviceType].name}</span>
            </Button>
          ))}
        </div>
      ...
      {/* Preview Frame */}
      <div className="relative flex items-center justify-center bg-gray-100 dark:bg-gray-900 rounded-lg overflow-hidden" style={{ height: "calc(100vh - 200px)" }}>
        {isLoading && (
