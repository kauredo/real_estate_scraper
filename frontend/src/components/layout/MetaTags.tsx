...
const getFinalDescription = (
  ...
  return "Imobiliário de luxo em Portugal. O Sofia Galvão Group ajuda a comprar e vender imóveis premium em Lisboa, Porto e Algarve com orientação especializada.";
};
