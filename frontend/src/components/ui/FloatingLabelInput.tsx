    ...
    return (
      <div className="relative">
        <input
          ...
          className={cn(
            "peer flex h-12 w-full rounded-md border bg-white dark:bg-dark text-foreground dark:text-light px-3 pt-5 pb-2 text-sm transition-all duration-200 ease-out",
