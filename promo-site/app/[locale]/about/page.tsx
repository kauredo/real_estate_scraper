              ...
              <Card className="border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-white">
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold mb-2">{t('about.mission.vision.title')}</h3>
              ...
              <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-white">
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold mb-2">{t('about.mission.values.title')}</h3>
                      <p className="text-gray-600 text-sm">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="pt-8">
                ...
                <h3 className="text-xl font-bold mb-3">{t('about.different.realEstate.title')}</h3>
            ...
            <Card>
              <CardContent className="pt-8">
                ...
                <h3 className="text-xl font-bold mb-3">{t('about.different.modern.title')}</h3>
                <p className="text-gray-600">
            ...
            <Card>
              <CardContent className="pt-8">
                ...
                <h3 className="text-xl font-bold mb-3">{t('about.different.customerFirst.title')}</h3>
                <p className="text-gray-600">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-4 my-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="block mb-1">{t('about.story.benefits.fast.title')}</strong>
                  <span className="text-gray-600 text-sm">{t('about.story.benefits.fast.description')}</span>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-green-600 flex-shrink-0 mt-1" />
                <div>
                  <strong className="block mb-1">{t('about.story.benefits.easy.title')}</strong>
                  <span className="text-gray-600 text-sm">{t('about.story.benefits.easy.description')}</span>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-green-600 flex-shrink-0 mt-1" />
                <div>
                  <strong className="block mb-1">{t('about.story.benefits.affordable.title')}</strong>
                  <span className="text-gray-600 text-sm">{t('about.story.benefits.affordable.description')}</span>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 className="h-6 w-6 text-green-600 flex-shrink-0 mt-1" />
                <div>
                  <strong className="block mb-1">{t('about.story.benefits.professional.title')}</strong>
                  <span className="text-gray-600 text-sm">{t('about.story.benefits.professional.description')}</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-blue-600 mb-2">{t('about.stats.launchTime.value')}</div>
              <p className="text-gray-600">{t('about.stats.launchTime.label')}</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-blue-600 mb-2">{t('about.stats.uptime.value')}</div>
              <p className="text-gray-600">{t('about.stats.uptime.label')}</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-blue-600 mb-2">{t('about.stats.support.value')}</div>
              <p className="text-gray-600">{t('about.stats.support.label')}</p>
            </div>
            <div>
              <div className="text-4xl font-bold text-blue-600 mb-2">{t('about.stats.technical.value')}</div>
              <p className="text-gray-600">{t('about.stats.technical.label')}</p>
            </div>
          </div>
        </div>
      </section>
