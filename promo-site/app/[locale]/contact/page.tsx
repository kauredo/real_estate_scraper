      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight mb-6">
            ...
            <br />
            <span className="text-blue-600">{t('contact.hero.titleHighlight')}</span>
          </h1>
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div>
                      <p className="text-sm text-gray-600">{t('contact.info.email.general')}</p>
                      <a href="mailto:hello@myagentwebsite.com" className="text-blue-600 hover:underline">
                        hello@myagentwebsite.com
                      </a>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">{t('contact.info.email.support')}</p>
                      <a href="mailto:support@myagentwebsite.com" className="text-blue-600 hover:underline">
              ...
              <Card className="bg-gradient-to-br from-blue-600 to-purple-600 text-white border-0">
                <CardContent className="pt-6">
                  <h3 className="text-xl font-bold mb-2">{t('contact.info.trial.title')}</h3>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">{t('contact.faq.heading')}</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">{t('contact.faq.questions.launch.question')}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">{t('contact.faq.questions.technical.question')}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">{t('contact.faq.questions.domain.question')}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">{t('contact.faq.questions.help.question')}</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-sm">
