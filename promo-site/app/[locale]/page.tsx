      ...
      <section className="py-12 bg-white border-y">
        <div className="container mx-auto px-4">
          <div className="flex justify-center items-center gap-12 flex-wrap text-center max-w-4xl mx-auto">
            <div>
              <div className="text-3xl font-bold text-blue-600 mb-1">{t('home.valueProposition.timeline')}</div>
              <p className="text-gray-600">{t('home.valueProposition.timelineDesc')}</p>
            </div>
            <div>
              <div className="text-3xl font-bold text-blue-600 mb-1">{t('home.valueProposition.tech')}</div>
              <p className="text-gray-600">{t('home.valueProposition.techDesc')}</p>
            </div>
            <div>
              <div className="text-3xl font-bold text-blue-600 mb-1">{t('home.valueProposition.service')}</div>
              <p className="text-gray-600">{t('home.valueProposition.serviceDesc')}</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <CardContent className="pt-12 pb-12">
              <div className="max-w-4xl mx-auto">
                ...
                <div className="flex items-center gap-4 mb-12 pl-8">
                  ...
                  <div>
                    <div className="font-bold text-lg">{t('home.caseStudy.author')}</div>
                    <div className="text-gray-600">{t('home.caseStudy.role')}</div>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <a href="https://sofiagalvao.pt" target="_blank" rel="noopener noreferrer">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-2 hover:border-blue-600 transition">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold mb-2">{t('home.benefits.professional.title')}</h3>
            ...
            <Card className="border-2 hover:border-blue-600 transition">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold mb-2">{t('home.benefits.flexible.title')}</h3>
                <p className="text-gray-600">
            ...
            <Card className="border-2 hover:border-blue-600 transition">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold mb-2">{t('home.benefits.modern.title')}</h3>
                <p className="text-gray-600">
            ...
            <Card className="border-2 hover:border-blue-600 transition">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-bold mb-2">{t('home.benefits.brand.title')}</h3>
                <p className="text-gray-600">
          ...
          <div className="space-y-16">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                <h3 className="text-3xl font-bold mb-4">{t('home.showcase.dashboard.title')}</h3>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-3xl font-bold mb-4">{t('home.showcase.website.title')}</h3>
                <p className="text-lg text-gray-600">
            ...
            {/* Mobile Experience */}
            <div className="text-center">
              <h3 className="text-3xl font-bold mb-4">{t('home.showcase.mobile.title')}</h3>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1">{t('home.features.listings.title')}</h3>
                    <p className="text-gray-600">{t('home.features.listings.description')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold mb-1">{t('home.features.blog.title')}</h3>
                    <p className="text-gray-600">{t('home.features.blog.description')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold mb-1">{t('home.features.testimonials.title')}</h3>
                    <p className="text-gray-600">{t('home.features.testimonials.description')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold mb-1">{t('home.features.newsletter.title')}</h3>
                    <p className="text-gray-600">{t('home.features.newsletter.description')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="h-6 w-6 text-green-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold mb-1">{t('home.features.domain.title')}</h3>
                    <p className="text-gray-600">{t('home.features.domain.description')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white shadow-2xl">
                <div className="space-y-4">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    ...
                    <p className="text-sm text-white/80">Manage everything from one place</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
