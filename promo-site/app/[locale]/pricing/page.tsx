              ...
              <CardHeader>
                ...
                <div className="mb-4">
                  ...
                  <span className="text-gray-600">
                    {t("pricing.plans.developer.priceUnit")}
                  </span>
                </div>
                <CardDescription>
              ...
              <CardContent>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      {t("pricing.plans.developer.features.apiAccess")}
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>
                      {t("pricing.plans.developer.features.ownFrontend")}
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>
                      {t("pricing.plans.developer.features.listings")}
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                  ...
                  <div className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>
                      {t("pricing.plans.developer.features.multiTenant")}
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
              ...
              <CardHeader>
                ...
                <div className="mb-4">
                  <span className="text-lg text-gray-600">
                    {t("pricing.plans.professional.priceLabel")}
                  </span>
                  <br />
                  <span className="text-4xl font-bold">
                  ...
                  <span className="text-gray-600">
                    {t("pricing.plans.professional.priceUnit")}
                  </span>
                </div>
                <CardDescription>
              ...
              <CardContent>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>
                      {t("pricing.plans.professional.features.setup")}
                    </span>
                  </div>
                  <div className="text-xs text-gray-500 mt-4 pt-4 border-t">
              ...
              <CardContent>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span>
                      {t("pricing.plans.enterprise.features.multiple")}
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2">
                  ...
                  <th className="text-center py-4 px-4 font-semibold bg-blue-50">
              ...
              <tbody className="divide-y">
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.customWebsite")}
                  </td>
                  <td className="text-center py-4 px-4 text-gray-400">
                    {t("pricing.comparison.values.buildYourOwn")}
                  </td>
                ...
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.apiAccess")}
                  </td>
                  <td className="text-center py-4 px-4">
                    <CheckCircle2 className="h-5 w-5 text-green-600 mx-auto" />
                  </td>
                ...
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.backoffice")}
                  </td>
                  <td className="text-center py-4 px-4">
                    <CheckCircle2 className="h-5 w-5 text-green-600 mx-auto" />
                  </td>
                ...
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.listings")}
                  </td>
                  <td className="text-center py-4 px-4">
                ...
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.blog")}
                  </td>
                  <td className="text-center py-4 px-4">
                    <CheckCircle2 className="h-5 w-5 text-green-600 mx-auto" />
                  </td>
                ...
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.domain")}
                  </td>
                ...
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.hosting")}
                  </td>
                  <td className="text-center py-4 px-4">-</td>
                  <td className="text-center py-4 px-4 bg-blue-50">
                    <CheckCircle2 className="h-5 w-5 text-green-600 mx-auto" />
                ...
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.setupFee")}
                  </td>
                  <td className="text-center py-4 px-4">
                    {t("pricing.comparison.values.none")}
                  </td>
                  <td className="text-center py-4 px-4 bg-blue-50">€2,500</td>
                  <td className="text-center py-4 px-4">
                    {t("pricing.comparison.values.custom")}
                  </td>
                </tr>
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.multiple")}
                  </td>
                  <td className="text-center py-4 px-4">-</td>
                ...
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.whiteLabel")}
                  </td>
                  <td className="text-center py-4 px-4">-</td>
                  <td className="text-center py-4 px-4 bg-blue-50">-</td>
                  <td className="text-center py-4 px-4">
                ...
                <tr>
                  <td className="py-4 px-4">
                    {t("pricing.comparison.features.dedicated")}
                  </td>
                  <td className="text-center py-4 px-4">-</td>
                  <td className="text-center py-4 px-4 bg-blue-50">-</td>
                  <td className="text-center py-4 px-4">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  {t("pricing.faq.questions.launch.question")}
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  {t("pricing.faq.questions.setupFee.question")}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  {t("pricing.faq.questions.switch.question")}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  {t("pricing.faq.questions.payment.question")}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  {t("pricing.faq.questions.ownership.question")}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">
                  {t("pricing.faq.questions.cancel.question")}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
